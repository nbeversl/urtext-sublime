...
class GenerateTimelineCommand(sublime_plugin.TextCommand):
    ...
    def run(self,edit):
        ...
        for file in files:
          print(os.path.join(Urtext.get_path(self.view.window()), file))
          try:
            with open(os.path.join(Urtext.get_path(self.view.window()), file),'r',encoding='utf-8') as theFile:
            ...
            print('Unicode errot with %s' % file)
